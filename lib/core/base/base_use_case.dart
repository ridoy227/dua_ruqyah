...
abstract class BaseUseCase<T> {
  ...
  /// The `getRight` function is used to extract the successful data from the `fetchData` result, with a default value of 0 if it's not available.
  ...
  Future<T> getRight(
    ...
    return result.getRight().getOrElse(() => defaultValue);
  }
